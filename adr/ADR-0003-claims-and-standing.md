...
| 2026-08-15 | **Amended by [ADR-0008](ADR-0008-discovery-http-surface.md)** — adds the claim reads (`GET /claims`, `GET /claims/{id}`) and the admin skill-request queue, neither of which ADR-0003 gave a URL.                                              |
