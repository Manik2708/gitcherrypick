...
| 2026-08-16 | **Amended by [ADR-0009](ADR-0009-github-identity-uniqueness.md)** — `github_user_id` gains a partial unique index per namespace. Two contributors could previously hold one GitHub identity, making `ByGitHubUserID` — the whole basis of contributor sign-in — ambiguous. |
