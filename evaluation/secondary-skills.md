...
The rule of thumb from the original design: *"if it constitutes 30% of the diff and has
nearly the same impact, award 30% of the primary; if impact and complexity are very high,
award up to 100% or more."*
...
Kubernetes?" but "how much of *this change* was Kubernetes, and how much did it matter?"
