...
The five dimensions in [dimensions.md](dimensions.md) assess *authoring* and do not transfer.
...
Reviewing well is mostly deciding what *not* to raise. A reviewer who blocks on formatting
...
| Score | Archetype |
|---|---|
| 90–100 | Every comment specific and actionable, with the *why* included. Disagreement expressed as reasoning, not authority. The author could act without a follow-up question. |
...
problem and the author merged regardless, that is the *author's* outcome. Score the review
