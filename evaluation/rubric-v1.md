...
shift of weight from _how well you did it_ toward _where you did it_ — the trade is that a
...
| `project_component = 0.30`  | Newly doubled. Weights _where_ you contributed heavily against _how well_; may now overshoot.                     |
